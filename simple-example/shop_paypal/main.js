...
let cart = [];
// 當local 記憶體裡面有值 把資料拉shopping cart
...
addToCartButtonsDOM.forEach(addToCartButtonDOM => { // 有加 {} 跟沒加 {}是不一樣的 有加括弧 不會 return 沒加的會return
...
function insertItemToDOM(product) {
    ...
    <div class="cart__item">
        <img class="cart__item__image" src="${product.image}" alt="${product}">
...
function checkout() {
    ...
    <input type="hidden" name="business" value="asd61404@gmail.com">
    `;
